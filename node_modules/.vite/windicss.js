...
function padding(utility, _a) {
  var theme = _a.theme;
  return utility.handler.handleStatic(theme("padding")).handleSquareBrackets().handleSpacing().handleSize().handleVariable().callback(function(value) {
...
function margin(utility, _a) {
  var theme = _a.theme;
  return utility.handler.handleStatic(theme("margin")).handleSquareBrackets().handleSpacing().handleSize().handleNegative().handleVariable().callback(function(value) {
    var directions = expandDirection(utility.identifier.substring(1), false);
    if (directions) {
      if (directions[0] === "*")
...
var Processor = function() {
    ...
    var _loop_3 = function(key2, value2) {
      ...
      if (typeof value2 === "string") {
        this_1._plugin.shortcuts[key2] = this_1.compile(value2, void 0, void 0, false, void 0, cssEscape(prefix + key2)).styleSheet.children.map(function(i) {
          return i.updateMeta("components", "shortcuts", layerOrder["shortcuts"]);
        });
      } else {
        var styles_1 = [];
  ...
  Processor2.prototype.addUtilities = function(utilities, options) {
    ...
    var _loop_4 = function(key2, value2) {
      ...
      if (options.layer)
        styles.forEach(function(style) {
          return style.updateMeta(layer, "plugin", order2);
        });
    ...
    this._plugin.dynamic[key] = key in this._plugin.dynamic ? function(Utility2) {
      ...
      if (Array.isArray(output))
        return output.map(function(i) {
          return i.updateMeta(layer, group, order2, 0, false, i.meta.respectSelector || uOptions.respectSelector);
        });
      return output.updateMeta(layer, group, order2, 0, false, output.meta.respectSelector || uOptions.respectSelector);
    };
    return generator;
  };
  ...
  Processor2.prototype.addBase = function(baseStyles) {
    ...
    for (var _i = 0, _a = Object.entries(baseStyles); _i < _a.length; _i++) {
      ...
      var styles = Style.generate(key, value).map(function(i) {
        return i.updateMeta("base", "plugin", 10);
      });
